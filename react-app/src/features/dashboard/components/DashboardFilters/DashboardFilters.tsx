    ...
    <div className="bg-slate-800 rounded-md px-3 py-2 border border-slate-700 shadow-md">
      <div className="flex justify-between items-start">
        <div className="inline-flex items-center gap-2 mt-1">
          ...
          >
            {isExpanded ? (<span>OCULTAR FILTROS</span>) : (<span>MOSTRAR FILTROS</span>)}
          </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium text-slate-200 border ${
              activeFiltersCount > 0 ? 'border-blue-500 hover:bg-blue-500' : 'border-slate-700 opacity-50 cursor-not-allowed'
      ...
      {isExpanded && (
        <div className="text-base grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-2 mt-2">
          <div>
            <ManageableDropdown
              label="Deportes"
